...
type QueryWithCancelTokenHookReturnType<TData, TVariables> = QueryResult<TData, TVariables> & {
  abort: () => void;
};
 ...
 */
function useQueryWithCancelToken<TData = any, TVariables = OperationVariables>(

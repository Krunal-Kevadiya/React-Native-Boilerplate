  ...
  return CustomStyleSheet.create(
    {
      ...
      customBackdrop: {
        flex: 1,
        backgroundColorDark: colorOpacity(Colors[option.themeMode]?.black, 0.1),
        backgroundColor: colorOpacity(Colors[option.themeMode]?.black, 0.99)
      },
      headerContainer: {
        marginBottom: '10@vs',
      ...
      popupStyle: {
        ...
        width: '100%',
        backgroundColor: Colors[option.themeMode]?.invertedTransparentBlack
      },
      popupView: {
        height: '100%',
        justifyContent: 'flex-end',
